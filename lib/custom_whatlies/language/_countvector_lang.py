...
class CountVectorLanguage(SklearnTransformerMixin):
    """
    This object is used to lazily fetch [Embedding][bulk_labelling.custom_whatlies.embedding.Embedding]s or
    [EmbeddingSet][bulk_labelling.custom_whatlies.embeddingset.EmbeddingSet]s from a countvector language
    ...
    **Usage**:
    ...
    ```python
    > from bulk_labelling.custom_whatlies.language import CountVectorLanguage
    ...
    def score_similar(
        ...
        Returns:
            An list of ([Embedding][bulk_labelling.custom_whatlies.embedding.Embedding], score) tuples.
        """
