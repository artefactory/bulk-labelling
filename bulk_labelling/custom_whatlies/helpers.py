from bulk_labelling.custom_whatlies import Embedding, EmbeddingSet
...
def reverse_strings(embset):
    ...
    ```python
    from bulk_labelling.custom_whatlies.helpers import reverse_strings
    from bulk_labelling.custom_whatlies.language import BytePairLanguage
